...
const Evaluation = () => {
  const [evaluation, setEvalutaion] = React.useState([
    {
      group:'Group1',
      title:'Hello',
    ...
    <div className="w-full bg-gray-100 py-10 px-5 md:px-0">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div className="flex flex-col">
                <div className="my-4">
                    <h1 className="text-3xl font-bolder leading-tight text-gray-900">Evaluation</h1>
                </div>
                <div className="-mb-2 py-4 flex flex-wrap flex-grow justify-between">
                    ...
                    <div className="flex items-center py-2">
                        <NavLink to={"/evaluation"} className="inline-block px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:shadow-outline">
                            Evaluate
                        </NavLink>
                    ...
                    <div className="align-middle inline-block w-full shadow overflow-x-auto sm:rounded-lg border-b border-gray-200">
                        <table className="table-auto w-full">
                            ...
                            <tbody className="bg-white">
                                {evaluation.length >0 && evaluation.map((m) => (
                                    <tr id={m._id} key={evaluation.indexOf(m) + 1}>
