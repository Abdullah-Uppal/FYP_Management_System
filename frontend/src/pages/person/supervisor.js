                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="flex flex-col">
                        ...
                        <div className="-mb-2 py-4 flex flex-wrap flex-grow justify-between">
                            ...
                            <div className="flex items-center py-2">
                                <NavLink to={'/user/advisor/new'} className="inline-block px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:shadow-outline">
                                    Create
                                </NavLink>
                                        ...
                                        {persons && persons.map((person) => (
                                            <tr id={person._id} key={persons.indexOf(person) + 1}>
                                                ...
                                                <td className=" whitespace-no-wrap border-b border-gray-200">
                                                    <NavLink to={"/user/advisor/update/" + person._id}
